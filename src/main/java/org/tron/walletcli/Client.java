...
public class Client {
  ...
  private void assetIssue(String[] parameters)
    ...
    if (parameters == null || parameters.length < 12) {
      ...
      System.out.println("AssetIssue [OwnerAddress] AssetName AbbrName TotalSupply HrnNum AssetNum Precision "
      ...
      System.out.println("HrnNum and AssetNum represents the conversion ratio of the tron to the asset.");
    ...
    String hrnNumStr = parameters[index++];
    ...
    int hrnNum = new Integer(hrnNumStr);
    ...
    boolean result = walletApiWrapper.assetIssue(ownerAddress, name, abbrName, totalSupply,
        hrnNum, icoNum, precision, startTime, endTime, 0,
...
//  }
  ...
  private void deployContract(String[] parameter)
    ...
    if (parameters == null ||
      ...
      System.out.println(
          "DeployContract [ownerAddress] contractName ABI byteCode constructor params isHex fee_limit consume_user_resource_percent origin_energy_limit value token_value token_id(e.g: HRNTOKEN, use # if don't provided) <library:address,library:address,...> <lib_compiler_version(e.g:v5)>");
//      System.out.println(
  ...
  private void triggerContract(String[] parameters, boolean isConstant)
    ...
    if (isConstant) {
      ...
      if (parameters == null || (parameters.length != 8 && parameters.length != 9)) {
        ...
        System.out.println(cmdMethodStr + " [OwnerAddress] contractAddress method args isHex"
            + " fee_limit value token_value token_id(e.g: HRNTOKEN, use # if don't provided)");
        return;
      }
    }
  ...
  private void listShieldedNote(String[] parameters) {
    ...
    if (showType == 0) {
      ...
      for (Entry<Long, ShieldedNoteInfo> entry : noteMap.entrySet()) {
        ...
        string += " ";
        string += entry.getValue().getHrnId();
        string += " ";
